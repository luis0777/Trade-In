    ...
    <section>
      ...
      <div className="w-full flex items-center justify-center">
        <div className="w-full flex flex-wrap items-center justify-center gap-16 p-8">
          <Button
            className="w-60 bg-blue-600 text-lg font-semibold shadow-md flex items-center justify-center gaptransition-all duration-300 hover:scale-110 hover:shadow-xl"
