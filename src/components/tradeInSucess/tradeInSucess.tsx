...
export function TradeInSuccess() {
    const [currentComponent, setCurrentComponent] = useState<"TradeInSuccess" | "VerificarCPFCliente">("TradeInSuccess");
    ...
    return (
      <>
          ...
          <div className="w-full h-[40rem] flex items-center justify-center">
            <Card className="w-[450px] ">
                  ...
                  <div className="grid w-full items-center gap-4 text-center ">
                    <Accordion type="single" collapsible className="w-full">
                      ...
                      <AccordionItem value="item-2">
                        ...
                        <AccordionContent>Nenhuma campanha ativa no momento.</AccordionContent>
                      </AccordionItem>
                    </Accordion>
                  </div>
                </form>
              ...
              <CardFooter className="flex justify-center">
                <Button className="bg-blue-700 text-white" onClick={() => setCurrentComponent("VerificarCPFCliente")}>
                  Avançar
                </Button>
              </CardFooter>
            </Card>
        ...
        {currentComponent === "VerificarCPFCliente" && (
          <VerificarCPFCliente setShowPreviousComponent={() => setCurrentComponent("TradeInSuccess")} />
        )}
      </>
    );
  }
