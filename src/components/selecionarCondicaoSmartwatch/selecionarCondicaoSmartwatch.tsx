  ...
  return (
    <div className="w-full flex flex-col items-center justify-center pt-32 ">
      ...
      >
        <TabsList>
          <TabsTrigger value="1">
            {selections[1] ? selections[1] : "Questão 1"}
          </TabsTrigger>
          <TabsTrigger value="2">
            {selections[2] ? selections[2] : "Questão 2"}
          </TabsTrigger>
          <TabsTrigger value="3">
            {selections[3] ? selections[3] : "Questão 3"}
          </TabsTrigger>
          <TabsTrigger value="4">
            {selections[4] ? selections[4] : "Questão 4"}
          </TabsTrigger>
          <TabsTrigger value="5">
            {selections[5] ? selections[5] : "Questão 5"}
          </TabsTrigger>
          <TabsTrigger value="6">
            {selections[6] ? selections[6] : "Questão 6"}
          </TabsTrigger>
        </TabsList>
        <TabsContent value="1">
          <div>
